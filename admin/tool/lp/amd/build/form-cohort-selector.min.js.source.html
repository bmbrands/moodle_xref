...
<html>
<head>
    <title>PHPXRef 0.7.1 : Unnamed Project : /admin/tool/lp/amd/build/form-cohort-selector.min.js source</title>
...
filename='form-cohort-selector.min.js.source.html';
cookiekey='phpxref';
...
<h2 class="listing-heading"><a href="./index.html">/admin/tool/lp/amd/build/</a> -> <a href="form-cohort-selector.min.js.html">form-cohort-selector.min.js</a> (source)</h2>
<div class="listing">
<p class="viewlinks">[<a href="form-cohort-selector.min.js.html">Summary view</a>]
[<a href="javascript:window.print();">Print</a>]
[<a href="form-cohort-selector.min.js.source.txt" target="_new">Text view</a>]
</p>
<pre>
<a name="l1"><span class="linenum">   1</span></a>  <a class="phpfunction" onClick="logFunction('define')" href="../../../../../_functions/define.html" onMouseOver="phpfuncPopup(event,'define')">define</a>([&quot;jquery&quot;,&quot;core/ajax&quot;,&quot;core/templates&quot;],function(a,b,c){return{processResults:function(b,c){var d=[];return a.<a class="phpfunction" onClick="logFunction('each')" href="../../../../../_functions/each.html" onMouseOver="phpfuncPopup(event,'each')">each</a>(c,function(a,b){d.<a class="function" onClick="logFunction('push')" href="../../../../../_functions/push.html" onMouseOver="funcPopup(event,'push')">push</a>({value:b.id,label:b._label})}),d},transport:function(d,e,f,g){var h,i=parseInt(<a class="function" onClick="logFunction('a')" href="../../../../../_functions/a.html" onMouseOver="funcPopup(event,'a')">a</a>(d).<a class="function" onClick="logFunction('data')" href="../../../../../_functions/data.html" onMouseOver="funcPopup(event,'data')">data</a>(&quot;contextid&quot;),10),j=<a class="function" onClick="logFunction('a')" href="../../../../../_functions/a.html" onMouseOver="funcPopup(event,'a')">a</a>(d).<a class="function" onClick="logFunction('data')" href="../../../../../_functions/data.html" onMouseOver="funcPopup(event,'data')">data</a>(&quot;includes&quot;);h=b.<a class="function" onClick="logFunction('call')" href="../../../../../_functions/call.html" onMouseOver="funcPopup(event,'call')">call</a>([{methodname:&quot;tool_lp_search_cohorts&quot;,args:{query:e,context:{contextid:i},includes:j}}]),h[0].then(function(b){var d=[],e=0;return a.<a class="phpfunction" onClick="logFunction('each')" href="../../../../../_functions/each.html" onMouseOver="phpfuncPopup(event,'each')">each</a>(b.cohorts,function(a,b){d.<a class="function" onClick="logFunction('push')" href="../../../../../_functions/push.html" onMouseOver="funcPopup(event,'push')">push</a>(c.<a class="function" onClick="logFunction('render')" href="../../../../../_functions/render.html" onMouseOver="funcPopup(event,'render')">render</a>(&quot;tool_lp/form-cohort-selector-suggestion&quot;,b))}),a.when.<a class="function" onClick="logFunction('apply')" href="../../../../../_functions/apply.html" onMouseOver="funcPopup(event,'apply')">apply</a>(a.when,d).then(function(){var c=arguments;a.<a class="phpfunction" onClick="logFunction('each')" href="../../../../../_functions/each.html" onMouseOver="phpfuncPopup(event,'each')">each</a>(b.cohorts,function(a,b){b._label=c[e],e++}),<a class="function" onClick="logFunction('f')" href="../../../../../_functions/f.html" onMouseOver="funcPopup(event,'f')">f</a>(b.cohorts)})},g)}}});
</pre>
</div>
<script language="JavaScript" type="text/javascript">
FUNC_DATA={
