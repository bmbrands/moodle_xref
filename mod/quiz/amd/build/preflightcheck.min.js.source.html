...
<html>
<head>
    <title>PHPXRef 0.7.1 : Unnamed Project : /mod/quiz/amd/build/preflightcheck.min.js source</title>
...
ext='.html';
relbase='../../../../';
subdir='mod/quiz/amd/build';
filename='preflightcheck.min.js.source.html';
cookiekey='phpxref';
...
<h2 class="listing-heading"><a href="./index.html">/mod/quiz/amd/build/</a> -> <a href="preflightcheck.min.js.html">preflightcheck.min.js</a> (source)</h2>
<div class="listing">
<p class="viewlinks">[<a href="preflightcheck.min.js.html">Summary view</a>]
[<a href="javascript:window.print();">Print</a>]
[<a href="preflightcheck.min.js.source.txt" target="_new">Text view</a>]
</p>
<pre>
<a name="l1"><span class="linenum">   1</span></a>  <a class="phpfunction" onClick="logFunction('define')" href="../../../../_functions/define.html" onMouseOver="phpfuncPopup(event,'define')">define</a>([&quot;jquery&quot;,&quot;core/yui&quot;],function(a,b){var c={confirmDialogue:null,init:function(a,d,e,f){var g=a;b.use(&quot;moodle-core-notification&quot;,&quot;moodle-core-formchangechecker&quot;,&quot;io-form&quot;,function(){b.one(e)&amp;&amp;(c.confirmDialogue=new M.core.dialogue({headerContent:d,bodyContent:b.one(e),draggable:!0,visible:!1,center:!0,modal:!0,width:null,extraClasses:[&quot;mod_quiz_preflight_popup&quot;]}),b.one(a).<a class="function" onClick="logFunction('on')" href="../../../../_functions/on.html" onMouseOver="funcPopup(event,'on')">on</a>(&quot;click&quot;,c.displayDialogue),b.one(&quot;#id_cancel&quot;).<a class="function" onClick="logFunction('on')" href="../../../../_functions/on.html" onMouseOver="funcPopup(event,'on')">on</a>(&quot;click&quot;,c.hideDialogue),g=c.confirmDialogue.<a class="function" onClick="logFunction('get')" href="../../../../_functions/get.html" onMouseOver="funcPopup(event,'get')">get</a>(&quot;boundingBox&quot;).one('[name=&quot;submitbutton&quot;]')),f&amp;&amp;b.one(g).<a class="function" onClick="logFunction('on')" href="../../../../_functions/on.html" onMouseOver="funcPopup(event,'on')">on</a>(&quot;click&quot;,c.launchQuizPopup,c,f)})},displayDialogue:function(a){a&amp;&amp;a.halt(),c.confirmDialogue.<a class="function" onClick="logFunction('show')" href="../../../../_functions/show.html" onMouseOver="funcPopup(event,'show')">show</a>()},hideDialogue:function(a){a&amp;&amp;a.halt(),c.confirmDialogue.<a class="function" onClick="logFunction('hide')" href="../../../../_functions/hide.html" onMouseOver="funcPopup(event,'hide')">hide</a>(a)},launchQuizPopup:function(a,c){a.halt(),M.core_formchangechecker.reset_form_dirty_state();var d=a.target.ancestor(&quot;form&quot;);window.<a class="function" onClick="logFunction('openpopup')" href="../../../../_functions/openpopup.html" onMouseOver="funcPopup(event,'openpopup')">openpopup</a>(a,{url:d.<a class="function" onClick="logFunction('get')" href="../../../../_functions/get.html" onMouseOver="funcPopup(event,'get')">get</a>(&quot;action&quot;)+&quot;?&quot;+b.IO.stringify(d).<a class="function" onClick="logFunction('replace')" href="../../../../_functions/replace.html" onMouseOver="funcPopup(event,'replace')">replace</a>(/\bcancel=/,&quot;x=&quot;),windowname:&quot;quizpopup&quot;,options:c,fullscreen:!0})}};return c});
</pre>
</div>
<script language="JavaScript" type="text/javascript">
FUNC_DATA={
