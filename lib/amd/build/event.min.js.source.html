...
<html>
<head>
    <title>PHPXRef 0.7.1 : Unnamed Project : /lib/amd/build/event.min.js source</title>
...
filename='event.min.js.source.html';
cookiekey='phpxref';
...
<h2 class="listing-heading"><a href="./index.html">/lib/amd/build/</a> -> <a href="event.min.js.html">event.min.js</a> (source)</h2>
<div class="listing">
<p class="viewlinks">[<a href="event.min.js.html">Summary view</a>]
[<a href="javascript:window.print();">Print</a>]
[<a href="event.min.js.source.txt" target="_new">Text view</a>]
</p>
<pre>
<a name="l1"><span class="linenum">   1</span></a>  <a class="phpfunction" onClick="logFunction('define')" href="../../../_functions/define.html" onMouseOver="phpfuncPopup(event,'define')">define</a>([&quot;jquery&quot;,&quot;core/yui&quot;],function(a,b){return{notifyFilterContentUpdated:function(c){c=<a class="function" onClick="logFunction('a')" href="../../../_functions/a.html" onMouseOver="funcPopup(event,'a')">a</a>(c),b.use(&quot;event&quot;,&quot;moodle-core-event&quot;,function(b){<a class="function" onClick="logFunction('a')" href="../../../_functions/a.html" onMouseOver="funcPopup(event,'a')">a</a>(document).<a class="function" onClick="logFunction('trigger')" href="../../../_functions/trigger.html" onMouseOver="funcPopup(event,'trigger')">trigger</a>(M.core.event.FILTER_CONTENT_UPDATED,c);var d=new b.<a class="function" onClick="logFunction('NodeList')" href="../../../_functions/nodelist.html" onMouseOver="funcPopup(event,'nodelist')">NodeList</a>(c.<a class="function" onClick="logFunction('get')" href="../../../_functions/get.html" onMouseOver="funcPopup(event,'get')">get</a>());b.fire(M.core.event.FILTER_CONTENT_UPDATED,{nodes:d})})},notifyEditorContentRestored:function(){b.use(&quot;event&quot;,&quot;moodle-core-event&quot;,function(b){<a class="function" onClick="logFunction('a')" href="../../../_functions/a.html" onMouseOver="funcPopup(event,'a')">a</a>(document).<a class="function" onClick="logFunction('trigger')" href="../../../_functions/trigger.html" onMouseOver="funcPopup(event,'trigger')">trigger</a>(M.core.event.EDITOR_CONTENT_RESTORED),b.fire(M.core.event.EDITOR_CONTENT_RESTORED)})}}});
</pre>
</div>
<script language="JavaScript" type="text/javascript">
FUNC_DATA={
...
'nodelist': ['nodelist', 'Enter description here ... ', [['backup/cc/cc_lib','xmlbase.php',258]], 60],
