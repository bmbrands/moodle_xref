...
<html>
<head>
    <title>PHPXRef 0.7.1 : Unnamed Project : /lib/amd/build/chart_builder.min.js source</title>
...
filename='chart_builder.min.js.source.html';
cookiekey='phpxref';
...
<h2 class="listing-heading"><a href="./index.html">/lib/amd/build/</a> -> <a href="chart_builder.min.js.html">chart_builder.min.js</a> (source)</h2>
<div class="listing">
<p class="viewlinks">[<a href="chart_builder.min.js.html">Summary view</a>]
[<a href="javascript:window.print();">Print</a>]
[<a href="chart_builder.min.js.source.txt" target="_new">Text view</a>]
</p>
<pre>
<a name="l1"><span class="linenum">   1</span></a>  <a class="phpfunction" onClick="logFunction('define')" href="../../../_functions/define.html" onMouseOver="phpfuncPopup(event,'define')">define</a>([&quot;jquery&quot;],function(a){var b={make:function(b){var c=a.Deferred();return <a class="function" onClick="logFunction('require')" href="../../../_functions/require.html" onMouseOver="funcPopup(event,'require')">require</a>([&quot;core/chart_&quot;+b.type],function(a){var d=a.prototype.<a class="function" onClick="logFunction('create')" href="../../../_functions/create.html" onMouseOver="funcPopup(event,'create')">create</a>(a,b);c.<a class="function" onClick="logFunction('resolve')" href="../../../_functions/resolve.html" onMouseOver="funcPopup(event,'resolve')">resolve</a>(d)}),c.<a class="function" onClick="logFunction('promise')" href="../../../_functions/promise.html" onMouseOver="funcPopup(event,'promise')">promise</a>()}};return b});
</pre>
</div>
<script language="JavaScript" type="text/javascript">
FUNC_DATA={
