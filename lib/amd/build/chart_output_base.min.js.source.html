...
<html>
<head>
    <title>PHPXRef 0.7.1 : Unnamed Project : /lib/amd/build/chart_output_base.min.js source</title>
...
filename='chart_output_base.min.js.source.html';
cookiekey='phpxref';
...
<h2 class="listing-heading"><a href="./index.html">/lib/amd/build/</a> -> <a href="chart_output_base.min.js.html">chart_output_base.min.js</a> (source)</h2>
<div class="listing">
<p class="viewlinks">[<a href="chart_output_base.min.js.html">Summary view</a>]
[<a href="javascript:window.print();">Print</a>]
[<a href="chart_output_base.min.js.source.txt" target="_new">Text view</a>]
</p>
<pre>
<a name="l1"><span class="linenum">   1</span></a>  <a class="phpfunction" onClick="logFunction('define')" href="../../../_functions/define.html" onMouseOver="phpfuncPopup(event,'define')">define</a>([&quot;jquery&quot;],function(a){function <a class="function" onClick="logFunction('b')" href="../../../_functions/b.html" onMouseOver="funcPopup(event,'b')">b</a>(b,c){this._node=<a class="function" onClick="logFunction('a')" href="../../../_functions/a.html" onMouseOver="funcPopup(event,'a')">a</a>(b),this._chart=c}return b.prototype.update=function(){throw new <a class="function" onClick="logFunction('Error')" href="../../../_functions/error.html" onMouseOver="funcPopup(event,'error')">Error</a>(&quot;Not supported.&quot;)},b});
</pre>
</div>
<script language="JavaScript" type="text/javascript">
FUNC_DATA={
