...
<html>
<head>
    <title>PHPXRef 0.7.1 : Unnamed Project : /lib/jquery/jquery-migrate-1.2.1.min.js source</title>
...
relbase='../../';
subdir='lib/jquery';
filename='jquery-migrate-1.2.1.min.js.source.html';
cookiekey='phpxref';
...
<h2 class="listing-heading"><a href="./index.html">/lib/jquery/</a> -> <a href="jquery-migrate-1.2.1.min.js.html">jquery-migrate-1.2.1.min.js</a> (source)</h2>
<div class="listing">
<p class="viewlinks">[<a href="jquery-migrate-1.2.1.min.js.html">Summary view</a>]
[<a href="javascript:window.print();">Print</a>]
[<a href="jquery-migrate-1.2.1.min.js.source.txt" target="_new">Text view</a>]
</p>
<pre>
<a name="l1"><span class="linenum">   1</span></a>  <span class="comment">/*! jQuery Migrate v1.2.1 | (c) 2005, 2013 jQuery Foundation, Inc. and other contributors | jquery.org/license */</span>
<a name="l2"><span class="linenum">   2</span></a>  jQuery.migrateMute===void 0&amp;&amp;(jQuery.migrateMute=!0),function(e,t,n){function <a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(n){var r=t.console;i[n]||(i[n]=!0,e.migrateWarnings.<a class="function" onClick="logFunction('push')" href="../../_functions/push.html" onMouseOver="funcPopup(event,'push')">push</a>(n),r&amp;&amp;r.warn&amp;&amp;!e.migrateMute&amp;&amp;(r.<a class="function" onClick="logFunction('warn')" href="../../_functions/warn.html" onMouseOver="funcPopup(event,'warn')">warn</a>(&quot;JQMIGRATE: &quot;+n),e.migrateTrace&amp;&amp;r.trace&amp;&amp;r.<a class="function" onClick="logFunction('trace')" href="../../_functions/trace.html" onMouseOver="funcPopup(event,'trace')">trace</a>()))}function <a class="function" onClick="logFunction('a')" href="../../_functions/a.html" onMouseOver="funcPopup(event,'a')">a</a>(t,a,i,o){if(Object.defineProperty)try{return Object.defineProperty(t,a,{configurable:!0,enumerable:!0,get:function(){return <a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(o),i},set:function(e){<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(o),i=e}}),n}catch(s){}e._definePropertyBroken=!0,t[a]=i}var i={};e.migrateWarnings=[],!e.migrateMute&amp;&amp;t.console&amp;&amp;t.console.log&amp;&amp;t.console.<a class="phpfunction" onClick="logFunction('log')" href="../../_functions/log.html" onMouseOver="phpfuncPopup(event,'log')">log</a>(&quot;JQMIGRATE: Logging is active&quot;),e.migrateTrace===n&amp;&amp;(e.migrateTrace=!0),e.migrateReset=function(){i={},e.migrateWarnings.length=0},&quot;BackCompat&quot;===document.compatMode&amp;&amp;<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;jQuery is not compatible with Quirks Mode&quot;);var o=<a class="function" onClick="logFunction('e')" href="../../_functions/e.html" onMouseOver="funcPopup(event,'e')">e</a>(&quot;&lt;input/&gt;&quot;,{size:1}).attr(&quot;size&quot;)&amp;&amp;e.attrFn,s=e.attr,u=e.attrHooks.value&amp;&amp;e.attrHooks.value.get||function(){return null},c=e.attrHooks.value&amp;&amp;e.attrHooks.value.set||function(){return n},l=/^(?:input|button)$/i,d=/^[238]$/,p=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,f=/^(?:checked|selected)$/i;<a class="function" onClick="logFunction('a')" href="../../_functions/a.html" onMouseOver="funcPopup(event,'a')">a</a>(e,&quot;attrFn&quot;,o||{},&quot;jQuery.attrFn is deprecated&quot;),e.attr=function(t,a,i,u){var c=a.toLowerCase(),g=t&amp;&amp;t.nodeType;return u&amp;&amp;(4&gt;s.length&amp;&amp;<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;jQuery.fn.attr( props, pass ) is deprecated&quot;),t&amp;&amp;!d.test(g)&amp;&amp;(o?a in o:e.<a class="function" onClick="logFunction('isFunction')" href="../../_functions/isfunction.html" onMouseOver="funcPopup(event,'isfunction')">isFunction</a>(e.fn[a])))?<a class="function" onClick="logFunction('e')" href="../../_functions/e.html" onMouseOver="funcPopup(event,'e')">e</a>(t)[a](i):(&quot;type&quot;===a&amp;&amp;i!==n&amp;&amp;l.test(t.nodeName)&amp;&amp;t.parentNode&amp;&amp;<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;Can't change the 'type' of an input or button in IE 6/7/8&quot;),!e.attrHooks[c]&amp;&amp;p.test(c)&amp;&amp;(e.attrHooks[c]={get:function(t,r){var a,i=e.prop(t,r);return i===!0||&quot;boolean&quot;!=typeof i&amp;&amp;(a=t.getAttributeNode(r))&amp;&amp;a.nodeValue!==!1?r.toLowerCase():n},set:function(t,n,r){var a;return n===!1?e.removeAttr(t,r):(a=e.propFix[r]||r,a in t&amp;&amp;(t[a]=!0),t.<a class="function" onClick="logFunction('setAttribute')" href="../../_functions/setattribute.html" onMouseOver="funcPopup(event,'setattribute')">setAttribute</a>(r,r.toLowerCase())),r}},f.test(c)&amp;&amp;<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;jQuery.fn.attr('&quot;+c+&quot;') may use property instead of attribute&quot;)),s.<a class="function" onClick="logFunction('call')" href="../../_functions/call.html" onMouseOver="funcPopup(event,'call')">call</a>(e,t,a,i))},e.attrHooks.value={get:function(e,t){var n=(e.nodeName||&quot;&quot;).toLowerCase();return&quot;button&quot;===n?u.<a class="function" onClick="logFunction('apply')" href="../../_functions/apply.html" onMouseOver="funcPopup(event,'apply')">apply</a>(this,arguments):(&quot;input&quot;!==n&amp;&amp;&quot;option&quot;!==n&amp;&amp;<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;jQuery.fn.attr('value') no longer gets properties&quot;),t in e?e.value:null)},set:function(e,t){var a=(e.nodeName||&quot;&quot;).toLowerCase();return&quot;button&quot;===a?c.<a class="function" onClick="logFunction('apply')" href="../../_functions/apply.html" onMouseOver="funcPopup(event,'apply')">apply</a>(this,arguments):(&quot;input&quot;!==a&amp;&amp;&quot;option&quot;!==a&amp;&amp;<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;jQuery.fn.attr('value', val) no longer sets properties&quot;),e.value=t,n)}};var g,h,v=e.fn.init,m=e.parseJSON,y=/^([^&lt;]*)(&lt;[\w\W]+&gt;)([^&gt;]*)$/;e.fn.init=function(t,n,a){var i;return t&amp;&amp;&quot;string&quot;==typeof t&amp;&amp;!e.isPlainObject(n)&amp;&amp;(i=y.<a class="phpfunction" onClick="logFunction('exec')" href="../../_functions/exec.html" onMouseOver="phpfuncPopup(event,'exec')">exec</a>(e.<a class="phpfunction" onClick="logFunction('trim')" href="../../_functions/trim.html" onMouseOver="phpfuncPopup(event,'trim')">trim</a>(t)))&amp;&amp;i[0]&amp;&amp;(&quot;&lt;&quot;!==t.charAt(0)&amp;&amp;<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;$(html) HTML strings must start with '&lt;' character&quot;),i[3]&amp;&amp;<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;$(html) HTML text after last tag is ignored&quot;),&quot;#&quot;===i[0].charAt(0)&amp;&amp;(<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;HTML string cannot start with a '#' character&quot;),e.<a class="function" onClick="logFunction('error')" href="../../_functions/error.html" onMouseOver="funcPopup(event,'error')">error</a>(&quot;JQMIGRATE: Invalid selector string (XSS)&quot;)),n&amp;&amp;n.context&amp;&amp;(n=n.context),e.parseHTML)?v.<a class="function" onClick="logFunction('call')" href="../../_functions/call.html" onMouseOver="funcPopup(event,'call')">call</a>(this,e.parseHTML(i[2],n,!0),n,a):v.<a class="function" onClick="logFunction('apply')" href="../../_functions/apply.html" onMouseOver="funcPopup(event,'apply')">apply</a>(this,arguments)},e.fn.init.prototype=e.fn,e.parseJSON=function(e){return e||null===e?m.<a class="function" onClick="logFunction('apply')" href="../../_functions/apply.html" onMouseOver="funcPopup(event,'apply')">apply</a>(this,arguments):(<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;jQuery.parseJSON requires a valid JSON string&quot;),null)},e.uaMatch=function(e){e=e.toLowerCase();var t=/(chrome)[ \/]([\w.]+)/.<a class="phpfunction" onClick="logFunction('exec')" href="../../_functions/exec.html" onMouseOver="phpfuncPopup(event,'exec')">exec</a>(e)||/(webkit)[ \/]([\w.]+)/.<a class="phpfunction" onClick="logFunction('exec')" href="../../_functions/exec.html" onMouseOver="phpfuncPopup(event,'exec')">exec</a>(e)||/(opera)(?:.*version|)[ \/]([\w.]+)/.<a class="phpfunction" onClick="logFunction('exec')" href="../../_functions/exec.html" onMouseOver="phpfuncPopup(event,'exec')">exec</a>(e)||/(msie) ([\w.]+)/.<a class="phpfunction" onClick="logFunction('exec')" href="../../_functions/exec.html" onMouseOver="phpfuncPopup(event,'exec')">exec</a>(e)||0&gt;e.<a class="function" onClick="logFunction('indexOf')" href="../../_functions/indexof.html" onMouseOver="funcPopup(event,'indexof')">indexOf</a>(&quot;compatible&quot;)&amp;&amp;/(mozilla)(?:.*? rv:([\w.]+)|)/.<a class="phpfunction" onClick="logFunction('exec')" href="../../_functions/exec.html" onMouseOver="phpfuncPopup(event,'exec')">exec</a>(e)||[];return{browser:t[1]||&quot;&quot;,version:t[2]||&quot;0&quot;}},e.browser||(g=e.uaMatch(navigator.userAgent),h={},g.browser&amp;&amp;(h[g.browser]=!0,h.version=g.version),h.chrome?h.webkit=!0:h.webkit&amp;&amp;(h.safari=!0),e.browser=h),<a class="function" onClick="logFunction('a')" href="../../_functions/a.html" onMouseOver="funcPopup(event,'a')">a</a>(e,&quot;browser&quot;,e.browser,&quot;jQuery.browser is deprecated&quot;),e.sub=function(){function <a class="function" onClick="logFunction('t')" href="../../_functions/t.html" onMouseOver="funcPopup(event,'t')">t</a>(e,n){return new t.fn.<a class="function" onClick="logFunction('init')" href="../../_functions/init.html" onMouseOver="funcPopup(event,'init')">init</a>(e,n)}e.<a class="function" onClick="logFunction('extend')" href="../../_functions/extend.html" onMouseOver="funcPopup(event,'extend')">extend</a>(!0,t,this),t.superclass=this,t.fn=t.prototype=this(),t.fn.constructor=t,t.sub=this.sub,t.fn.init=function(r,a){return a&amp;&amp;a instanceof e&amp;&amp;!(a instanceof t)&amp;&amp;(a=<a class="function" onClick="logFunction('t')" href="../../_functions/t.html" onMouseOver="funcPopup(event,'t')">t</a>(a)),e.fn.init.<a class="function" onClick="logFunction('call')" href="../../_functions/call.html" onMouseOver="funcPopup(event,'call')">call</a>(this,r,a,n)},t.fn.init.prototype=t.fn;var n=<a class="function" onClick="logFunction('t')" href="../../_functions/t.html" onMouseOver="funcPopup(event,'t')">t</a>(document);return <a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;jQuery.<a class="function" onClick="logFunction('sub')" href="../../_functions/sub.html" onMouseOver="funcPopup(event,'sub')">sub</a>() is deprecated&quot;),t},e.ajaxSetup({converters:{&quot;text json&quot;:e.parseJSON}});var b=e.fn.data;e.fn.data=function(t){var a,i,o=this[0];return!o||&quot;events&quot;!==t||1!==arguments.length||(a=e.<a class="function" onClick="logFunction('data')" href="../../_functions/data.html" onMouseOver="funcPopup(event,'data')">data</a>(o,t),i=e.<a class="function" onClick="logFunction('_data')" href="../../_functions/_data.html" onMouseOver="funcPopup(event,'_data')">_data</a>(o,t),a!==n&amp;&amp;a!==i||i===n)?b.<a class="function" onClick="logFunction('apply')" href="../../_functions/apply.html" onMouseOver="funcPopup(event,'apply')">apply</a>(this,arguments):(<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;Use of jQuery.fn.<a class="function" onClick="logFunction('data')" href="../../_functions/data.html" onMouseOver="funcPopup(event,'data')">data</a>('events') is deprecated&quot;),i)};var j=/\/(java|ecma)script/i,w=e.fn.andSelf||e.fn.addBack;e.fn.andSelf=function(){return <a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;jQuery.fn.andSelf() replaced by jQuery.fn.addBack()&quot;),w.<a class="function" onClick="logFunction('apply')" href="../../_functions/apply.html" onMouseOver="funcPopup(event,'apply')">apply</a>(this,arguments)},e.clean||(e.clean=function(t,a,i,o){a=a||document,a=!a.nodeType&amp;&amp;a[0]||a,a=a.ownerDocument||a,<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;jQuery.clean() is deprecated&quot;);var s,u,c,l,d=[];if(e.<a class="function" onClick="logFunction('merge')" href="../../_functions/merge.html" onMouseOver="funcPopup(event,'merge')">merge</a>(d,e.buildFragment(t,a).childNodes),i)for(c=function(e){return!e.type||j.test(e.type)?o?o.<a class="function" onClick="logFunction('push')" href="../../_functions/push.html" onMouseOver="funcPopup(event,'push')">push</a>(e.parentNode?e.parentNode.<a class="function" onClick="logFunction('removeChild')" href="../../_functions/removechild.html" onMouseOver="funcPopup(event,'removechild')">removeChild</a>(e):e):i.appendChild(e):n},s=0;null!=(u=d[s]);s++)e.nodeName(u,&quot;script&quot;)&amp;&amp;<a class="function" onClick="logFunction('c')" href="../../_functions/c.html" onMouseOver="funcPopup(event,'c')">c</a>(u)||(i.appendChild(u),u.getElementsByTagName!==n&amp;&amp;(l=e.grep(e.<a class="function" onClick="logFunction('merge')" href="../../_functions/merge.html" onMouseOver="funcPopup(event,'merge')">merge</a>([],u.getElementsByTagName(&quot;script&quot;)),c),d.splice.<a class="function" onClick="logFunction('apply')" href="../../_functions/apply.html" onMouseOver="funcPopup(event,'apply')">apply</a>(d,[s+1,0].<a class="function" onClick="logFunction('concat')" href="../../_functions/concat.html" onMouseOver="funcPopup(event,'concat')">concat</a>(l)),s+=l.length));return d});var Q=e.event.add,x=e.event.remove,k=e.event.trigger,N=e.fn.toggle,T=e.fn.live,M=e.fn.die,S=&quot;ajaxStart|ajaxStop|ajaxSend|ajaxComplete|ajaxError|ajaxSuccess&quot;,C=RegExp(&quot;\\<a class="function" onClick="logFunction('b')" href="../../_functions/b.html" onMouseOver="funcPopup(event,'b')">b</a>(?:&quot;+S+&quot;)\\b&quot;),H=/(?:^|\s)hover(\.\S+|)\b/,A=function(t){return&quot;string&quot;!=typeof t||e.event.special.hover?t:(H.test(t)&amp;&amp;<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;'hover' pseudo-event is deprecated, use 'mouseenter mouseleave'&quot;),t&amp;&amp;t.<a class="function" onClick="logFunction('replace')" href="../../_functions/replace.html" onMouseOver="funcPopup(event,'replace')">replace</a>(H,&quot;mouseenter<a class="var it229" onMouseOver="hilite(229)" onMouseOut="lolite()" onClick="logVariable('1')" href="../../_variables/1.html">$1</a> mouseleave<a class="var it229" onMouseOver="hilite(229)" onMouseOut="lolite()" onClick="logVariable('1')" href="../../_variables/1.html">$1</a>&quot;))};e.event.props&amp;&amp;&quot;attrChange&quot;!==e.event.props[0]&amp;&amp;e.event.props.unshift(&quot;attrChange&quot;,&quot;attrName&quot;,&quot;relatedNode&quot;,&quot;srcElement&quot;),e.event.dispatch&amp;&amp;<a class="function" onClick="logFunction('a')" href="../../_functions/a.html" onMouseOver="funcPopup(event,'a')">a</a>(e.event,&quot;handle&quot;,e.event.dispatch,&quot;jQuery.event.handle is undocumented and deprecated&quot;),e.event.add=function(e,t,n,a,i){e!==document&amp;&amp;C.test(t)&amp;&amp;<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;AJAX events should be attached to document: &quot;+t),Q.<a class="function" onClick="logFunction('call')" href="../../_functions/call.html" onMouseOver="funcPopup(event,'call')">call</a>(this,e,<a class="function" onClick="logFunction('A')" href="../../_functions/a.html" onMouseOver="funcPopup(event,'a')">A</a>(t||&quot;&quot;),n,a,i)},e.event.remove=function(e,t,n,r,a){x.<a class="function" onClick="logFunction('call')" href="../../_functions/call.html" onMouseOver="funcPopup(event,'call')">call</a>(this,e,<a class="function" onClick="logFunction('A')" href="../../_functions/a.html" onMouseOver="funcPopup(event,'a')">A</a>(t)||&quot;&quot;,n,r,a)},e.fn.error=function(){var e=Array.prototype.slice.<a class="function" onClick="logFunction('call')" href="../../_functions/call.html" onMouseOver="funcPopup(event,'call')">call</a>(arguments,0);return <a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;jQuery.fn.<a class="function" onClick="logFunction('error')" href="../../_functions/error.html" onMouseOver="funcPopup(event,'error')">error</a>() is deprecated&quot;),e.<a class="function" onClick="logFunction('splice')" href="../../_functions/splice.html" onMouseOver="funcPopup(event,'splice')">splice</a>(0,0,&quot;error&quot;),arguments.length?this.bind.<a class="function" onClick="logFunction('apply')" href="../../_functions/apply.html" onMouseOver="funcPopup(event,'apply')">apply</a>(this,e):(this.triggerHandler.<a class="function" onClick="logFunction('apply')" href="../../_functions/apply.html" onMouseOver="funcPopup(event,'apply')">apply</a>(this,e),this)},e.fn.toggle=function(t,n){if(!e.<a class="function" onClick="logFunction('isFunction')" href="../../_functions/isfunction.html" onMouseOver="funcPopup(event,'isfunction')">isFunction</a>(t)||!e.<a class="function" onClick="logFunction('isFunction')" href="../../_functions/isfunction.html" onMouseOver="funcPopup(event,'isfunction')">isFunction</a>(n))return N.<a class="function" onClick="logFunction('apply')" href="../../_functions/apply.html" onMouseOver="funcPopup(event,'apply')">apply</a>(this,arguments);<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;jQuery.fn.<a class="function" onClick="logFunction('toggle')" href="../../_functions/toggle.html" onMouseOver="funcPopup(event,'toggle')">toggle</a>(handler, handler...) is deprecated&quot;);var a=arguments,i=t.guid||e.guid++,o=0,s=function(n){var r=(e.<a class="function" onClick="logFunction('_data')" href="../../_functions/_data.html" onMouseOver="funcPopup(event,'_data')">_data</a>(this,&quot;lastToggle&quot;+t.guid)||0)%o;return e.<a class="function" onClick="logFunction('_data')" href="../../_functions/_data.html" onMouseOver="funcPopup(event,'_data')">_data</a>(this,&quot;lastToggle&quot;+t.guid,r+1),n.preventDefault(),a[r].<a class="function" onClick="logFunction('apply')" href="../../_functions/apply.html" onMouseOver="funcPopup(event,'apply')">apply</a>(this,arguments)||!1};for(s.guid=i;a.length&gt;o;)a[o++].guid=i;return this.click(s)},e.fn.live=function(t,n,a){return <a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;jQuery.fn.live() is deprecated&quot;),T?T.<a class="function" onClick="logFunction('apply')" href="../../_functions/apply.html" onMouseOver="funcPopup(event,'apply')">apply</a>(this,arguments):(<a class="function" onClick="logFunction('e')" href="../../_functions/e.html" onMouseOver="funcPopup(event,'e')">e</a>(this.context).<a class="function" onClick="logFunction('on')" href="../../_functions/on.html" onMouseOver="funcPopup(event,'on')">on</a>(t,this.selector,n,a),this)},e.fn.die=function(t,n){return <a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;jQuery.fn.die() is deprecated&quot;),M?M.<a class="function" onClick="logFunction('apply')" href="../../_functions/apply.html" onMouseOver="funcPopup(event,'apply')">apply</a>(this,arguments):(<a class="function" onClick="logFunction('e')" href="../../_functions/e.html" onMouseOver="funcPopup(event,'e')">e</a>(this.context).off(t,this.selector||&quot;**&quot;,n),this)},e.event.trigger=function(e,t,n,a){return n||C.test(e)||<a class="function" onClick="logFunction('r')" href="../../_functions/r.html" onMouseOver="funcPopup(event,'r')">r</a>(&quot;Global events are undocumented and deprecated&quot;),k.<a class="function" onClick="logFunction('call')" href="../../_functions/call.html" onMouseOver="funcPopup(event,'call')">call</a>(this,e,t,n||document,a)},e.<a class="phpfunction" onClick="logFunction('each')" href="../../_functions/each.html" onMouseOver="phpfuncPopup(event,'each')">each</a>(S.<a class="phpfunction" onClick="logFunction('split')" href="../../_functions/split.html" onMouseOver="phpfuncPopup(event,'split')">split</a>(&quot;|&quot;),function(t,n){e.event.special[n]={setup:function(){var t=this;return t!==document&amp;&amp;(e.event.<a class="function" onClick="logFunction('add')" href="../../_functions/add.html" onMouseOver="funcPopup(event,'add')">add</a>(document,n+&quot;.&quot;+e.guid,function(){e.event.<a class="function" onClick="logFunction('trigger')" href="../../_functions/trigger.html" onMouseOver="funcPopup(event,'trigger')">trigger</a>(n,null,t,!0)}),e.<a class="function" onClick="logFunction('_data')" href="../../_functions/_data.html" onMouseOver="funcPopup(event,'_data')">_data</a>(this,n,e.guid++)),!1},teardown:function(){return this!==document&amp;&amp;e.event.<a class="function" onClick="logFunction('remove')" href="../../_functions/remove.html" onMouseOver="funcPopup(event,'remove')">remove</a>(document,n+&quot;.&quot;+e.<a class="function" onClick="logFunction('_data')" href="../../_functions/_data.html" onMouseOver="funcPopup(event,'_data')">_data</a>(this,n)),!1}}})}(jQuery,window);
</pre>
</div>
<script language="JavaScript" type="text/javascript">
FUNC_DATA={
'extend': ['extend', 'Extend the lifetime of this lock. Not supported by all factories. ', [['lib/classes/lock','lock.php',81]], 1336],
'toggle': ['toggle', '', [['lib/editor/tinymce/tiny_mce/3.5.11','tiny_mce_src.js',17248]], 25],
...
'trace': ['trace', 'trace ', [['lib/phpexcel/PHPExcel/Shared/JAMA','Matrix.php',391],['lib/minify/lib','FirePHP.php',442],['mod/chat','chatd.php',156],['lib','filelib.php',3457],['auth/cas/CAS','CAS.php',509]], 163],
'_data': ['_data', '', [['lib/yuilib/3.17.2/io-xdr','io-xdr.js',90],['lib/yuilib/3.17.2/io-xdr','io-xdr-debug.js',90]], 106],
...
'warn': ['warn', '', [['lib/editor/tinymce/plugins/spellchecker/classes/utils','Logger.php',151],['lib/minify/lib','FirePHP.php',403],['lib/editor/atto/yui/build/moodle-editor_atto-rangy','moodle-editor_atto-rangy-debug.js',99],['lib/editor/atto/yui/build/moodle-editor_atto-rangy','moodle-editor_atto-rangy.js',99],['lib/editor/atto/yui/src/rangy/js','rangy-core.js',99],['lib/editor/tinymce/plugins/spellchecker/includes','general.php',84]], 19],
...
'r': ['r', 'Allows a gettext string to be defined and recognized as a string by the horde translation utilities, but no translation is actually performed (raw gettext = r()). ', [['lib/horde/framework/Horde','Translation.php',118]], 482],
